  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <p>
            Estos cuadernillos están diseñados específicamente para niños de
            7-16 años que reciben su educación principalmente en japonés o
            inglés, pero que necesitan reforzar sus conocimientos formales de
            español. Los niños ya tienen buena comprensión auditiva y uso
            natural de la gramática española, pero necesitan estructura formal
            en lectura y escritura.
          </p>
          <p style={{ marginTop: "1rem" }}>
            Cada cuadernillo contiene 6 páginas de ejercicios: diálogo
            contextualizado, conjugación y completado, ejercicios de elección
            múltiple, transformaciones, ordenamiento de palabras y corrección de
            errores. Formato DIN A5 con texto grande y espaciado amplio,
      ...
      <section>
        ...
        >
          ...
          <p style={{ color: "#B8842B", fontSize: "0.9rem" }}>
            ...
            imprimir en papel A4 estándar, selecciona la opción "2 páginas por
            hoja" en tu impresora para obtener el tamaño de texto correcto para
            niños.
          </p>
        </div>
      </section>
        ...
        >
          <div>
            ...
            <p style={{ color: "#4b5563", fontSize: "0.95rem" }}>
              Elige entre instrucciones en japonés o inglés según el idioma de
              educación del niño.
            </p>
          </div>
          <div>
            ...
            <p style={{ color: "#4b5563", fontSize: "0.95rem" }}>
              Imprime en formato DIN A5 para obtener el tamaño de texto
              optimizado.
            </p>
          </div>
          <div>
            ...
            <p style={{ color: "#4b5563", fontSize: "0.95rem" }}>
              Completa los 6 tipos de ejercicios para reforzar cada conjugación
              verbal.
            </p>
          </div>
        </div>
